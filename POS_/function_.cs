...
namespace POS_
{
    class function_
    {
        ...
        string i =Connection.connString;// @"server=127.0.0.1;user id=root;database=hardwear;default command timeout=1000";//arifpos
      ...
      //  string i = @"database='hardwear'; datasource='192.168.8.15'; username='root'; password='12345';default command timeout=1000";
        ...
        public double CalculateAmountByUsingDatagridviewithCondiWithCountOtherColumGo(DataGridView dgv, int columindes, int columother)
        {
            totalamount = 0;
            for (int a = 0; dgv.Rows.Count > a; a++)
            {
        ...
        public void getData(AutoCompleteStringCollection dataCollection, string sql)
        {
            ...
            MySqlConnection connection = new MySqlConnection(BUSS.Config.ConnectionString);
